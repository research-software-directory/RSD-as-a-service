...
export async function findOrdicInRSD({orcidList,token}:{orcidList:string[],token:string}) {
  try{
...
export async function importOrcidList({orcidList,token}:{orcidList:RsdOrcid[],token:string}){
  try{
