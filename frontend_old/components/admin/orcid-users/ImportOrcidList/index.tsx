...
import {OrcidBulkImportReport, RsdOrcid, importOrcidList} from './apiImportOrcidList'
...
export default function BulkImportOrcid({loadOrcidList}:BulkImportOrcidProps) {
  ...
  const [validationReport, setValidationReport] = useState<OrcidBulkImportReport>(null)
