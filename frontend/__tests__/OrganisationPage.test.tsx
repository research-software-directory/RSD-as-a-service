...
const mockSoftwareForOrganisation = jest.fn(props =>
	Promise.resolve({
		status: 206,
		count: 0,
		data: [],
...
jest.mock(
	'~/components/organisation/software/filters/useOrgSoftwareKeywordsList',
);
jest.mock(
	'~/components/organisation/software/filters/useOrgSoftwareLanguagesList',
);
jest.mock(
	'~/components/organisation/software/filters/useOrgSoftwareLicensesList',
);

// MOCK getProjectsForOrganisation
const mockProjectsForOrganisation = jest.fn(props =>
	Promise.resolve({
		status: 206,
		count: 0,
		data: [],
...
jest.mock('~/components/organisation/apiOrganisations', () => ({
	getSoftwareForOrganisation: jest.fn(props =>
		mockSoftwareForOrganisation(props),
	),
	getProjectsForOrganisation: jest.fn(props =>
		mockProjectsForOrganisation(props),
	),
	getOrganisationChildren: jest.fn(props =>
		mockGetOrganisationChildren(props),
	),
}));

// MOCK project filters - use default mocks
jest.mock(
	'~/components/organisation/projects/filters/useOrgProjectDomainsList',
);
jest.mock(
	'~/components/organisation/projects/filters/useOrgProjectKeywordsList',
);
jest.mock(
	'~/components/organisation/projects/filters/useOrgProjectOrganisationsList',
);
