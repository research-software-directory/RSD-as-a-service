...
import LogoEscience from '~/assets/LogoEscience.svg'
import LogoHelmholtz from '~/assets/LogoHelmholtz.svg'
import LogoLeiden from '~/assets/LogoLeiden.svg'
import LogoUMC from '~/assets/LogoUMC.svg'
import LogoUU from '~/assets/LogoUU.svg'
