...
export default function OrganisationSignUpDialog({
	...
	const [name, organisation, role, description] = watch([
		'name',
		'organisation',
		'role',
		'description',
		...
		>
			<div className="h-full w-full bg-[#232323] p-6">
				<div className="mx-auto">
					<div className="text-base-100 text-xl mb-4">{title}</div>
					<div className="text-sm text-[#B7B7B7] pb-4">
						You can find more information about registering your
						organisation in our{' '}
						<u>
							<a
								href="/documentation/users/register-organisation/"
								target="_blank"
								rel="noreferrer"
							>
								documentation
