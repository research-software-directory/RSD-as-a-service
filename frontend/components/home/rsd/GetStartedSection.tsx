...
function GlowingButton({
	...
	return (
		<a href={url} className="flex gap-4 cursor-pointer" target={target}>
...
export default function GetStartedSection() {
	return (
		<section id="get-started" className="p-5 md:px-10">
			<h2
			...
			>
				...
				Get more information on how to add your own software or
				organization.
			</p>
			<div className="max-w-screen-lg mt-6 mx-auto flex flex-wrap justify-center gap-4 p-2 scale-90">
				<div
