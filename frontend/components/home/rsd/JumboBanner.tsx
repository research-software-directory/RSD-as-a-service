		...
		<div className="max-w-screen-xl mx-auto p-4  grid lg:grid-cols-[1fr,1fr] gap-8 md:gap-20 lg:my-20 md:px-10">
			...
			>
				...
				<div className="mt-8 text-lg">
					The{' '}
					<span className="text-transparent font-medium bg-clip-text bg-gradient-to-tr from-[#03A9F1] to-[#09FBD3] px-1">
						Research Software Directory
					</span>
					is designed to show the impact research software has on
					research and society. We stimulate the reuse of research
					software and encourage proper citation to ensure researchers
					and RSEs get credit for their work.
				</div>
			</div>
