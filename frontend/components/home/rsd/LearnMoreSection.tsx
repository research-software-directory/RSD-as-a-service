		...
		>
			...
			<div>
				...
				<p
					...
					data-aos-easing="ease-in-out"
				>
					Try out our online demo, or get more detailed information in
					our documentation and FAQ.
				</p>

				<div className="flex flex-wrap justify-center gap-4 p-2 scale-90 mt-5">
					<div
