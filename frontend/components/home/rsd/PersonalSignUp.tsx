...
const inputClasses =
	'mb-4 placeholder:text-base-500 outline-0 p-2 w-full text-sm bg-transparent text-base-100 border border-base-600 rounded-sm';
...
export default function PersonalSignUp({
	...
	const [name, affiliation, role, orcid, description] = watch([
		'name',
		'affiliation',
		'role',
		'orcid',
		...
		<>
			...
			>
				<div className="relative group">
					<div className="absolute -inset-1 bg-gradient-to-r from-glow-start to-glow-end rounded-lg blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-300" />
					<div
				...
				<div className="h-full w-full bg-[#232323] p-6">
					<div className="mx-auto">
						...
						<div className="text-sm text-[#B7B7B7] pb-4">
							You can find more information about how to get
							access in our{' '}
							<u>
								<a
									href="/documentation/users/getting-access/"
									target="_blank"
									rel="noreferrer"
								>
									documentation
						...
						></textarea>
						<div className="text-sm text-[#B7B7B7]"></div>
						{/* NOTIFICATIONS */}
						<div className="text-sm text-[#B7B7B7] pb-4">
