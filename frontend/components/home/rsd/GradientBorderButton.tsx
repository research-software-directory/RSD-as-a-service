...
export default function GradientBorderButton({
	...
	return (
		<a href={url} className="cursor-pointer" target={target}>
			<button
				style={{minWidth}}
				className="group m-2 p-[0.125rem] rounded transition duration-500 bg-gradient-to-tl to-base-400 via-base-500 from-primary bg-size-200 bg-pos-0 hover:bg-pos-100"
			>
