...
function set_location_cookie() {
	...
	document.cookie =
		'rsd_pathname=/software/add;path=/auth;SameSite=None;Secure';
}

function submit_software_href(
	auth_status: string,
		...
		<MainContent>
			<div className="w-10/12 mx-auto p-5 md:p-10 grid lg:grid-cols-[1fr,1fr] gap-[2rem]">
				<div className="flex flex-col justify-left">
					...
					<div className="mt-8 ml-4 text-lg max-w-prose">
						...
						research. Despite this, it can be difficult to promote
						and showcase software through traditional academic
						means. The Imperial Research Software Directory provides
						a place to tell the world about your research software.
						Do you develop software at Imperial? Add your package to
						the directory!
					</div>
				</div>
			...
			<div className="max-w-screen-xl mx-auto flex flex-wrap justify-between gap-10 md:gap-16 p-5 md:p-10 ">
				...
				<CounterBox
					...
					value={(
						counts.software_cnt - counts.open_software_cnt
					).toString()}
				/>
				<CounterBox
