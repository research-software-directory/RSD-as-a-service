...
jest.mock('~/components/page/useMarkdownPages', () => {
  return {
    ...jest.requireActual('~/components/page/useMarkdownPages'),
...
describe('frontend/components/page/edit/index.tsx', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  })
  ...
  it('can delete markdown page', async() => {
    ...
    const deleteModal = screen.getByTestId('conform-delete-modal')
    // get confirm button
