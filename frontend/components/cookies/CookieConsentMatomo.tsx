 ...
 * @returns
 */
export default function CookieConsentMatomo({
	matomo,
	route,
}: CookieConsentMatomoProps) {
			...
			<div className="container mx-auto sm:px-20">
				<div className="border border-b-base-content border-t-4 border-x-4 border-b-0 bg-base-100 shadow-lg p-6 rounded-tr-3xl sm:w-96">
					<div className="w-16 mx-auto relative  mb-3">
						<CookieTwoToneIcon
							className="scale-[2]  mb-3"
							color="primary"
							fontSize="large"
						/>
					</div>
					<span className="w-full block leading-normal text-base-800 text-md mb-3">
						We use&nbsp;
					...
					<div className="flex items-center justify-between">
						<Link
							href="/cookies"
							passHref
							className="text-xs text-base-400 mr-1 hover:text-base-800 hover:underline"
						>
							Read more
						</Link>
