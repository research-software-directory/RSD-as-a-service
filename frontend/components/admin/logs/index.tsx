...
export default function ScraperErrorLogs() {
	const [orderBy, setOrderBy] =
		useState<OrderByProps<BackendLog, keyof BackendLog>>(initalOrder);
	const [columns, setColumns] = useState<
		Column<BackendLog, keyof BackendLog>[]
	>([]);
	const {loading, logs, loadLogs, deleteLog, deleteOldLogs} = useLogs({
		orderBy,
	});
