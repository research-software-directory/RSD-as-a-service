...
export default function ErrorInfoCell({
	message,
	stack_trace,
	other_data,
	id,
		...
		<>
			...
			<div className="flex items-center gap-4 font-bold">
				...
				<Tooltip
					...
					arrow
				>
					<IconButton onClick={() => toggleButton('other_data')}>
						<DataObjectIcon />
					</IconButton>
				</Tooltip>
				...
				<Tooltip
					...
					arrow
				>
					<IconButton onClick={() => toggleButton('stack_trace')}>
						<ErrorOutlineIcon />
					</IconButton>
				</Tooltip>
				...
				<Tooltip
					...
					arrow
				>
					<IconButton onClick={() => toggleButton('log_id')}>
						<KeyIcon />
					</IconButton>
				</Tooltip>
				{slug ?
