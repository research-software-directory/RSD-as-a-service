...
it('has links to software and project pages with the correct keyword filter', () => {
	...
	expect((links[0] as HTMLAnchorElement).href).toEqual(
		'http://localhost/software?keywords=%5B%22Big%20data%22%5D',
	);
	expect((links[1] as HTMLAnchorElement).href).toEqual(
		'http://localhost/projects?keywords=%5B%22Big%20data%22%5D',
	);
});
