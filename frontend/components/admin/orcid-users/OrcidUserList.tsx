...
export default function OrcidUserList({loading,searchFor,persons,addOrcid,removeOrcid}:OrcidUserListProps){
    ...
    return (
      <section className="flex-1">
        ...
        >
          ...
          Add user by providing a valid ORCID in the search box.<br/>
  ...
  return (
    <>
      ...
      <ConfirmDeleteModal
        ...
        body={
          <p>
            Are you sure you want to delete the account <strong>{modal?.person?.['orcid-id']}</strong>?
          </p>
        }
        onCancel={() => {
          setModal({
