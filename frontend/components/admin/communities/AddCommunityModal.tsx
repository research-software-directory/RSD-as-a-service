...
export default function AddPageModal({
	...
	const [slug, name, short_description, logo_id, logo_b64] = watch([
		'slug',
		'name',
		'short_description',
		'logo_id',
				...
				>
					<TextFieldWithCounter
						options={{
							...
							helperTextMessage:
								errors?.name?.message ?? config.name.help,
					...
					<SlugTextField
						...
						options={{
							...
							helperText:
								errors?.slug?.message ?? config.slug.help,
						}}
