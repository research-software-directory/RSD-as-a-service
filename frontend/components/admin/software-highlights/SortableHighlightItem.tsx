...
export default function SortableHighlightItem({
	pos,
	item,
	inCarousel,
	onEdit,
	...
	const {brand_name, contributor_cnt, mention_cnt, image_id, is_published} =
		item;
			...
			<ListItemText
				...
				secondary={
					<>
						...
						<span className="ml-4">
							Contributors: {contributor_cnt ?? 0}
						</span>
						<span className="ml-4">
							Published: {is_published ? 'Yes' : 'No'}
						</span>
						<span className="ml-4">
							Carousel: {inCarousel ? 'Yes' : 'No'}
						</span>
					</>
				}
			/>
