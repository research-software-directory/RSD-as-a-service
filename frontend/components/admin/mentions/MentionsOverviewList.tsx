...
export default function MentionsOverviewList({
	list,
	onUpdate,
}: {
	list: MentionItemProps[];
	onUpdate: Function;
}) {
	const [modalOpen, setModalOpen] = useState<boolean>(false);
	const [mentionToEdit, setMentionToEdit] = useState<
		MentionItemProps | undefined
	>(undefined);
