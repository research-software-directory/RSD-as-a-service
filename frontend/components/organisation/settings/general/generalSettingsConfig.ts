...
export const generalSettingsConfig = {
  ...
  website: {
    ...
    validation: {
      ...
      pattern: {
        value: /^https?:\/\/\S+\.\S+$/,
        message: 'Url should start with http(s):// and have at least one dot (.) and cannot contain white spaces'
      }
    }
  },
  short_description: {
  ...
  ror_id: {
    ...
    validation: {
      ...
      pattern: {
        ...
        message: 'ROR id is url and starts with https://ror.org/ and cannot include white spaces'
      }
    }
  },
  primary_maintainer: {
