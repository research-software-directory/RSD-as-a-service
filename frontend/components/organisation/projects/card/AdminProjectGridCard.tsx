...
export default function AdminProjectGridCard({
	item: project,
	...
	// debugger
	return (
		<div data-testid="admin-project-grid-card" className="relative h-full">
			...
			>
				<ProjectCardContent visibleKeywords={3} {...project} />
			</Link>
