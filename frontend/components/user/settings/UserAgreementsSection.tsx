...
export default function UserAgreementsSection({
	...
	return (
		<div className="py-4">
			...
			<div className="py-4">
				To be able to contribute to the RSD, we need to know that you
				agree to our Terms of Service, and that you have read the
				Privacy Statement. Please check all of the points below to
				proceed:
			</div>
			<div>
				<ControlledSwitch
						...
						label={
							<span>
								...
								<Link
									className="underline"
									target="_blank"
									href="/documentation/users/user-settings/#public-profile"
								>
									Public Profile
								</Link>
							</span>
