		...
		>
			...
			>
				<div className="relative flex">
					<CardTitle title={brand_name} className="m-4 mr-[4rem]">
						{renderPublished()} {brand_name}
					</CardTitle>
					<div className="flex w-[4rem] h-[4rem] justify-center items-center bg-base-100 text-base text-[1.5rem] absolute top-0 right-0 group-hover:text-secondary">
						{getInitals()}
					</div>
				</div>
