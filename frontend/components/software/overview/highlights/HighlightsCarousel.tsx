...
export const HighlightsCarousel = ({
	...
	if (typeof distance === 'undefined') {
		...
		return (
			<div
				ref={divRef}
				className="container mx-auto invisible sm:h-[22rem]"
			/>
		);
	}
		...
		<>
			...
			>
				...
				<div
					...
					// snap on mobile only
					className={
						'flex gap-4 snap-start sm:snap-none scroll-smooth overflow-x-scroll scrollbar-hide p-4'
					}
					style={{
						scrollbarWidth: 'none',
						left: -scrollPosition,
