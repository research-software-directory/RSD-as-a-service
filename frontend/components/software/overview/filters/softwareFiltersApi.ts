...
export async function softwareKeywordsFilter({
	search,
	keywords,
	prog_lang,
	licenses,
	...
	return genericSoftwareKeywordsFilter({
		search,
		keywords,
		prog_lang,
		licenses,
...
export async function highlightKeywordsFilter({
	search,
	keywords,
	prog_lang,
	licenses,
...
export async function genericSoftwareKeywordsFilter({
	search,
	keywords,
	prog_lang,
	licenses,
	rpc,
}: GenericSoftwareFilterProps) {
	try {
		...
		logger(
			`genericSoftwareKeywordsFilter (${rpc}): ${resp.status} ${resp.statusText}`,
			'warn',
		);
		return [];
	} catch (e: any) {
		logger(
			`genericSoftwareKeywordsFilter (${rpc}): ${e?.message}`,
			'error',
		);
		return [];
	}
...
export async function softwareLanguagesFilter({
	search,
	keywords,
	prog_lang,
	licenses,
	...
	return genericSoftwareLanguagesFilter({
		search,
		keywords,
		prog_lang,
		licenses,
...
export async function highlightLanguagesFilter({
	search,
	keywords,
	prog_lang,
	licenses,
...
export async function genericSoftwareLanguagesFilter({
	search,
	keywords,
	prog_lang,
	licenses,
	...
	try {
		...
		logger(
			`genericSoftwareLanguagesFilter (${rpc}): ${resp.status} ${resp.statusText}`,
			'warn',
		);
		return [];
	} catch (e: any) {
		logger(
			`genericSoftwareLanguagesFilter (${rpc}): ${e?.message}`,
			'error',
		);
		return [];
	}
...
export async function softwareLicensesFilter({
	search,
	keywords,
	prog_lang,
	licenses,
	...
	return genericSoftwareLicensesFilter({
		search,
		keywords,
		prog_lang,
		licenses,
...
export async function highlightLicensesFilter({
	search,
	keywords,
	prog_lang,
	licenses,
...
export async function genericSoftwareLicensesFilter({
	search,
	keywords,
	prog_lang,
	licenses,
	...
	try {
		...
		logger(
			`genericSoftwareLicensesFilter (${rpc}): ${resp.status} ${resp.statusText}`,
			'warn',
		);
		return [];
	} catch (e: any) {
		logger(
			`genericSoftwareLicensesFilter (${rpc}): ${e?.message}`,
			'error',
		);
		return [];
	}
