	...
	return (
		...
		>
			...
			>
				...
				<input type="hidden" {...register('license')} />
				...
				>
					...
					<ControlledTextField
						...
						options={{
							...
							helperTextMessage:
								...
								config.licenses.modal.license.help,
					...
					<ControlledTextField
						...
						options={{
							...
							helperTextMessage:
								errors['name']?.message ??
								config.licenses.modal.name.help,
					...
					<ControlledTextField
						...
						options={{
							...
							helperTextMessage:
								...
								config.licenses.modal.reference.help,
