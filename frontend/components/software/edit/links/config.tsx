...
export const config={
  get_started_url: {
    ...
    validation: {
      ...
      pattern: {
        value: /^https?:\/\/\S+\.\S+$/,
        message: 'URL should start with http(s):// and use at least one dot (.) and cannot include white spaces'
      }
    }
  },
  repository_url: {
    ...
    validation: {
      ...
      pattern: {
        value: /^https?:\/\/\S+\.\S+$/,
        message: 'URL should start with http(s)://, have at least one dot (.) and at least one slash (/) and cannot include white spaces.'
      }
    }
  },
  repository_platform: {
