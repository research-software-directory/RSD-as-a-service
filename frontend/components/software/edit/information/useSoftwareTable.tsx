...
export type EditSoftwareDescriptionProps = SoftwareTableItem &
	EditSoftwareImage;
...
export default function useSoftwareTable({
	slug,
	token,
}: {
	slug: string | null;
	...
	const [editSoftware, setEditSoftware] =
		useState<EditSoftwareDescriptionProps>();
