...
export default function EditSoftwareDescriptionInputs() {
	...
	const [id, slug, brand_name, short_statement] = watch([
		'id',
		'slug',
		'brand_name',
		'short_statement',
	...
	return (
		<EditSection className="md:flex md:flex-col-reverse md:justify-end xl:grid xl:grid-cols-[3fr,1fr] xl:px-0 xl:gap-[3rem]">
			<div className="py-2">
				{user?.role === 'rsd_admin' ?
					<>
