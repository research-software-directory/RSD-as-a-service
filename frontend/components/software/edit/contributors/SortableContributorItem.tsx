...
export default function SortableContributorItem({
	pos,
	item,
	onEdit,
	onDelete,
}: SortableContributorItemProps) {
	...
	const primaryText =
		item.is_contact_person ?
			<>
				...
				<span className="text-primary"> (contact person)</span>
			</>
		:	displayName;
	...
	return (
		...
		>
			...
			<ListItemText
				primary={primaryText}
				secondary={combineRoleAndAffiliation(item)}
			/>
		</SortableListItem>
	);
}
