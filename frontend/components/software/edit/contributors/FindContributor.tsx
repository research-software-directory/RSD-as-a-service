...
import AggregatedContributorModal, {
	NewRsdContributor,
} from './AggregatedContributorModal';
...
export default function FindContributor({
	software,
	position,
	onEdit,
	onSubmit,
}: FindContributorProps) {
	const {token} = useSession();
	const [modal, setModal] = useState<ModalState>();
	const [options, setOptions] = useState<
		AutocompleteOption<AggregatedPerson>[]
	>([]);
