...
import {
	...
	packageManagerSettings,
} from '../package-managers/apiPackageManager';
...
export default function PackageManagerServices() {
		...
		return (
			<div>
				{services.map(service => {
					...
					const svcInfo = packageManagerSettings[
							...
							<List key={service.url}>
								{svcInfo?.services.includes('downloads') ?
									<ServiceInfoListItem
										...
										scraped_at={
											service.download_count_scraped_at
										}
										last_error={
											service.download_count_last_error
										}
										url={service.url}
										platform={null}
								...
								{svcInfo?.services.includes('dependents') ?
									<ServiceInfoListItem
										...
										scraped_at={
											service.reverse_dependency_count_scraped_at
										}
										last_error={
											service.reverse_dependency_count_last_error
										}
										url={service.url}
										platform={null}
										scraping_disabled_reason={
											service.reverse_dependency_count_scraping_disabled_reason
										}
									/>
								:	null}
							</List>
	...
	return (
		<Alert severity="warning" sx={{marginTop: '0.5rem'}}>
			...
			No information about <strong>supported</strong> package managers is
			provided for this software.
		</Alert>
	);
}
