...
export async function createOrganisationAndAddToSoftware({
	item,
	token,
	software,
}: {
...
export async function addOrganisationToSoftware({
	software,
	organisation,
	position,
	token,
...
export async function deleteOrganisationFromSoftware({
	software,
	organisation,
	token,
}: {
