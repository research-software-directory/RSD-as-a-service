...
export default function PackageManagerInfo({
	pm_key,
}: {
	pm_key: PackageManagerTypes | null;
}) {
	if (typeof pm_key === 'undefined' || pm_key === null)
		return <PlatformPlaceholder />;
	...
	return (
		<div className="flex gap-8 items-start">
			...
			<div className="text-center">
				...
				<div className="text-base-content-disabled mt-2">
					{info.name}
				</div>
			</div>
		</div>
