...
const mockAddNewMentionToSoftware = jest.fn(props =>
	Promise.resolve({
		status: 200,
		message: props,
	}),
...
jest.mock('./apiRelatedOutput', () => ({
	...
	addNewMentionToSoftware: jest.fn(props =>
		mockAddNewMentionToSoftware(props),
	),
	removeMentionForSoftware: jest.fn(props =>
