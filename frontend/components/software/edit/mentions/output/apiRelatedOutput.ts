...
export async function findPublicationByTitle({
	...
	try {
		...
		logger(
			`findPublicationByTitle: ${resp.status} ${resp.statusText} [${url}]`,
			'error',
		);
		return [];
	} catch (e: any) {
...
export async function addNewMentionToSoftware({
	item,
	software,
	token,
}: {
...
export async function addToMentionForSoftware({
	mention,
	software,
	token,
}: {
...
export async function updateMentionForSoftware({
	mention,
	software,
	is_featured = false,
	token,
...
export async function removeMentionForSoftware({
	mention,
	software,
	token,
}: {
