...
export async function addToReferencePaperForSoftware({
	mention,
	software,
	token,
}: {
...
export async function addNewReferencePaperToSoftware({
	item,
	software,
	token,
}: {
...
export async function removeReferencePaperForSoftware({
	mention,
	software,
	token,
}: {
...
export async function getReferencePapersForSoftware({
	software,
	token,
}: {
	software: string;
	...
	try {
		...
		logger(
			`getReferencePapersForSoftware: [${resp.status}] [${url}]`,
			'error',
		);
		// query not found
		return [];
