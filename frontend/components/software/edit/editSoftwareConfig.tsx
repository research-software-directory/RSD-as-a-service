...
export const organisationInformation = {
  ...
  website: {
    ...
    validation: {
      ...
      pattern: {
        value: /^https?:\/\/\S+\.\S+$/,
        message: 'URL should start with http(s):// and have at least one dot (.) and cannot include white spaces'
      }
    }
  },
  slug: {
...
export const mentionInformation = {
  ...
  url: {
    ...
    validation: {
      pattern: {
        value: /^https?:\/\/\S+\.\S+$/,
        message: 'URL should start with http(s):// have at least one dot (.) and cannot include white spaces'
      }
    }
  },
  is_featured: {
