...
export default function CategoryEditTreeNode({
	node,
	community,
	onDelete,
	onMutation,
	...
	const [categoryData, setCategoryData] = useState<CategoryEntry | null>(
		null,
	);
	...
	async function deleteCategory(id: string) {
		...
		if (!resp.ok) {
			showErrorMessage(
				`Couldn't delete the category, we got the following error: ${await resp.text()}`,
			);
			return;
		}
