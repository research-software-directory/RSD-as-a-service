...
it('generates the category tree correctly', () => {
	const grandChild1: CategoryEntry = {
		id: 'grandChild1',
		parent: 'child1',
		short_name: '',
		name: '',
	...
	const grandChild2: CategoryEntry = {
		id: 'grandChild2',
		parent: 'child1',
		short_name: '',
		name: '',
	...
	const grandChild3: CategoryEntry = {
		id: 'grandChild3',
		parent: 'child2',
		short_name: '',
		name: '',
	...
	const grandChild4: CategoryEntry = {
		id: 'grandChild4',
		parent: 'child2',
		short_name: '',
		name: '',
