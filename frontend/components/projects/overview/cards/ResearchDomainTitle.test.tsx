...
it('renders LS domain label', () => {
	render(<ResearchDomainTitle domains={[mockData.ls.key]} />);
	screen.getByText(mockData.ls.label);
});

it('renders PE domain label', () => {
	render(<ResearchDomainTitle domains={[mockData.pe.key]} />);
	screen.getByText(mockData.pe.label);
});

it('renders SH domain label', () => {
	render(<ResearchDomainTitle domains={[mockData.sh.key]} />);
