...
export default function ListImageWithGradientPlaceholder({
	imgSrc,
	alt,
}: {
	imgSrc: string | null;
	...
	if (validImg === false || imgSrc === null) {
		...
		return (
			<div className="w-[6rem] self-stretch bg-gradient-to-br from-base-300 from-0% via-base-100 via-50% to-base-100" />
		);
	}
