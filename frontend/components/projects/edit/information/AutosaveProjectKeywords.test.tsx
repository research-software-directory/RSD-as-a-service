...
jest.mock('./searchForKeyword', () => ({
	searchForProjectKeyword: jest.fn(props =>
		mockSearchForProjectKeyword(props),
	),
}));

// MOCK addKeywordsToProject
const mockAddKeywordsToProject = jest.fn(props =>
	Promise.resolve({
		status: 200,
		message: 'OK',
	}),
);
const mockCreateOrGetKeyword = jest.fn(props =>
	Promise.resolve({
		status: 201,
		message: {
			id: 'test-keyword-id',
...
const mockDeleteKeywordFromProject = jest.fn(props =>
	Promise.resolve({
		status: 200,
		message: 'OK',
	}),
);
const mockSilentKeywordDelete = jest.fn(props =>
	Promise.resolve({
		status: 200,
		message: 'OK',
	}),
...
jest.mock('~/utils/editKeywords', () => ({
	...
	deleteKeywordFromProject: jest.fn(props =>
		mockDeleteKeywordFromProject(props),
	),
