...
const mockAdResearchDomainToProject = jest.fn(props =>
	Promise.resolve({
		status: 200,
		message: 'OK',
	}),
);
const mockDeleteResearchDomainFromProject = jest.fn(props =>
	Promise.resolve({
		status: 200,
		message: 'OK',
	}),
...
jest.mock('~/utils/editProject', () => ({
	addResearchDomainToProject: jest.fn(props =>
		mockAdResearchDomainToProject(props),
	),
	deleteResearchDomainFromProject: jest.fn(props =>
		mockDeleteResearchDomainFromProject(props),
	),
}));
