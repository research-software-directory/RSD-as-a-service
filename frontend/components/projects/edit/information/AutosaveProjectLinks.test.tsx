...
const mockUpdateProjectLink = jest.fn(props =>
	Promise.resolve({
		status: 200,
		message: 'OK',
	}),
);
const mockAddProjectLink = jest.fn(props =>
	Promise.resolve({
		status: 201,
		message: 'project-link-id',
	}),
);
const mockDeleteProjectLink = jest.fn(props =>
	Promise.resolve({
		status: 200,
		message: 'OK',
	}),
);
const mockPatchProjectLinkPositions = jest.fn(props =>
	Promise.resolve({
		status: 200,
		message: 'OK',
	}),
...
jest.mock('~/utils/editProject', () => ({
	...
	patchProjectLinkPositions: jest.fn(props =>
		mockPatchProjectLinkPositions(props),
	),
}));
