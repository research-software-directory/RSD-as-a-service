...
type FindOrganisationProps = {
	...
	searchForOrganisation: (
		props: SearchForOrganisationProps,
	) => Promise<AutocompleteOption<SearchOrganisation>[]>;
...
export default function FindOrganisation({
	...
	onCreate,
	searchForOrganisation,
}: FindOrganisationProps) {
	const [options, setOptions] = useState<
		AutocompleteOption<SearchOrganisation>[]
	>([]);
	...
	function onAddOrganisation(
		selected: AutocompleteOption<SearchOrganisation>,
	) {
