...
const mockGetImpactForProject = jest.fn(props =>
	Promise.resolve(mockImpactForProject),
);
...
const mockFindPublicationByTitle = jest.fn(props =>
	Promise.resolve(mockImpactForProject),
);
const mockAddNewImpactToProject = jest.fn(props =>
	Promise.resolve({
		status: 200,
		message: props,
	}),
...
const mockUseProjectMentionContext = jest.fn(
	props => mockProjectMentionContext,
);
jest.mock('~/components/projects/edit/mentions/ProjectMentionContext', () => ({
	useProjectMentionContext: jest.fn(props =>
		mockUseProjectMentionContext(props),
	),
}));
...
describe('frontend/components/project/edit/mentions/impact/index.tsx', () => {
	...
	it('renders loader when loading=true', () => {
		...
		mockUseProjectMentionContext.mockReturnValueOnce(
			mockProjectMentionContext,
		);
