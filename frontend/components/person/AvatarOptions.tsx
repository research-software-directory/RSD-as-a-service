...
export default function AvatarOptions(props: AvatarOptionsProps) {
	const {given_names, family_names, avatar_id, avatar_b64, avatar_options} =
		props;
		...
		<div className="grid grid-cols-2 gap-8">
			<div>
				...
				>
					<Avatar
						alt={
							getDisplayName({given_names, family_names}) ??
							'Unknown'
						}
			...
			<div>
				<h3 className="text-sm text-base-content-disabled pb-4">
					Avatar options
				</h3>
				<Box
					sx={{
				...
				>
					...
					<IconButton title="No image" onClick={onNoAvatar}>
						{getDisplayInitials({given_names, family_names})}
					</IconButton>
				</Box>
			</div>
