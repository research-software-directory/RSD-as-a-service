...
it('calls SET_LOADING action', () => {
	...
	function SetLoadingUseMentionReducer() {
		const {loading, setLoading} = useEditMentionReducer();

		useEffect(() => {
			setLoading(false);
		}, []);

		return <h1>{EditMentionActionType.SET_LOADING}</h1>;
	}
	// render
	render(
...
it('calls SET_MENTIONS action', () => {
	...
	function SetMentionsUseMentionReducer() {
		...
		return <h1>{EditMentionActionType.SET_MENTIONS}</h1>;
	}
	// render function
	render(
		<EditMentionContext.Provider
...
it('calls ON_ADD action', () => {
	...
	function UseMentionReducer() {
		...
		return <h1>{EditMentionActionType.ON_ADD}</h1>;
	}
	// render function
	render(
		<EditMentionContext.Provider
...
it('calls SET_EDIT_MODAL action', () => {
	...
	function UseMentionReducer() {
		...
		return <h1>{EditMentionActionType.SET_EDIT_MODAL}</h1>;
	}
	// render function
	render(
		<EditMentionContext.Provider
...
it('calls ON_SUBMIT action', () => {
	...
	function UseMentionReducer() {
		...
		return <h1>{EditMentionActionType.ON_SUBMIT}</h1>;
	}
	// render function
	render(
		<EditMentionContext.Provider
...
it('calls ON_UPDATE action', () => {
	...
	function UseMentionReducer() {
		...
		return <h1>{EditMentionActionType.ON_UPDATE}</h1>;
	}
	// render function
	render(
		<EditMentionContext.Provider
...
it('calls ON_DELETE action', () => {
	...
	function UseMentionReducer() {
		...
		return <h1>{EditMentionActionType.ON_DELETE}</h1>;
	}
	// render function
	render(
		<EditMentionContext.Provider
...
it('calls SET_CONFIRM_MODAL action', () => {
	...
	function UseMentionReducer() {
		...
		return <h1>{EditMentionActionType.SET_CONFIRM_MODAL}</h1>;
	}
	// render function
	render(
		<EditMentionContext.Provider
