...
export default function AsyncAutocompleteSC<T>({
	status,
	options,
	config,
	onSearch,
	...
	const [selected, setSelected] = useState<AutocompleteOption<T> | null>(
		null,
	);
	...
	function onInputChange(
		...
		// console.groupEnd()
		if (e?.key === 'Enter' && newInputValue.length >= config.minLength) {
		...
		<>
			<Autocomplete
				...
				filterOptions={(
					...
					const inputInOptions = options.some(
						option =>
