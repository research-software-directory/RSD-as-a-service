 ...
 * TESTIMONIALS
 */
// export async function getTestimonialsForSoftware(uuid: string,frontend?:boolean,token?:string) {
//   try {

//     let url = `${process.env.POSTGREST_URL}/testimonial?software=eq.${uuid}`
//     if (frontend === true) {
//       url = `/api/v1/testimonial?software=eq.${uuid}`
//     }
...
/**
 * CONTRIBUTORS - moved to editContributors, 2022-02-17
 */
