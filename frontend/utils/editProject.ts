...
export async function validProjectItem(
 ...
 */
export async function createOrganisationAndAddToProject({
	project,
	item,
	token,
	role = 'participating',
}: {
	item: EditOrganisation;
	project: string;
	token: string;
...
export async function addOrganisationToProject({
	project,
	organisation,
	role,
	position,
...
export async function patchProjectForOrganisation({
	project,
	organisation,
	data,
	token,
...
export async function patchOrganisationPositions({
	project,
	organisations,
	token,
}: {
...
export async function deleteOrganisationFromProject({
	project,
	organisation,
	role,
	token,
...
export async function addResearchDomainToProject({
	data,
	token,
}: {
	data: ResearchDomainForProject[];
	token: string;
}) {
	try {
...
export async function deleteResearchDomainFromProject({
	project,
	research_domain,
	token,
}: {
...
export async function patchProjectLinkPositions({
	links,
	token,
}: {
	links: ProjectLink[];
...
export async function createMaintainerLink({
	project,
	account,
	token,
}: {
...
export async function addRelatedSoftware({
	project,
	software,
	status,
	token,
...
export async function deleteRelatedSoftware({
	project,
	software,
	token,
}: {
...
export async function deleteRelatedProject({
	origin,
	relation,
	token,
}: {
