...
export async function getContributorsForSoftware({
	software,
	token,
}: {
	software: string;
...
export async function postContributor({
	contributor,
	token,
}: {
...
export async function patchContributor({
	contributor,
	token,
}: {
	contributor: PatchPerson;
	token: string;
}) {
	try {
...
export async function patchContributorPositions({
	contributors,
	token,
}: {
...
export async function deleteContributorsById({
	ids,
	token,
}: {
	ids: string[];
