...
export function sortOnDateProp(
	itemA: any,
	itemB: any,
	prop: string,
	sortDir: 'asc' | 'desc' = 'asc',
...
export function sortBySearchFor(
	itemA: any,
	itemB: any,
	prop: string,
	searchFor: string,
	...
	// exact match
	if (valA.toLowerCase() == searchFor.toLowerCase()) {
		return -1;
	}

	if (valB.toLowerCase() == searchFor.toLowerCase()) {
		return 1;
	}
