...
export default function InviteSoftwareMaintainer({
	softwareInfo,
	error,
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
	...
	if (id) {
		...
		const resp: InviteSoftwareMaintainerProps =
		...
		return {
			props: {
				...
				error: {
					status: 404,
					message:
						"This invite is invalid. It's missing invite id. Please ask the software maintainer to provide you a new link.",
				},
			},
		};
	}
