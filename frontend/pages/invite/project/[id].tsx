...
export default function InviteProjectMaintainer({
	projectInfo,
	error,
			...
			<ContentInTheMiddle>
				<div className="flex flex-col gap-4 items-center">
					<h2>
						{projectInfo?.title ?
							<span>
								You are now a maintainer of {projectInfo?.title}
							</span>
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
	...
	if (id) {
		...
		const claim: InviteProjectMaintainerProps =
		...
		return {
			props: {
				...
				error: {
					status: 404,
					message:
						"This invite is invalid. It's missing invite id. Please ask the project maintainer to provide you a new link.",
				},
			},
		};
	}
