...
export default function InviteOrganisationMaintainer({
	organisationInfo,
	error,
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
	...
	if (id) {
		...
		const resp: InviteOrganisationMaintainerProps =
	...
	return {
		props: {
			...
			error: {
				status: 404,
				message:
					"This invite is invalid. It's missing invite id. Please ask the organisation maintainer to provide you a new link.",
			},
		},
	};
}
