		...
		<>
			...
			<PageContainer className="flex-1">
				...
				<ProjectInfo
					...
					fundingOrganisations={organisations.filter(
						item => item.role === 'funding',
					)}
			...
			<DarkThemeSection>
				...
				<MentionsSection title="Impact" mentions={impact} />
				{/* Project output */}
				<MentionsSection title="Output" mentions={output} />
			</DarkThemeSection>
			{/* Team (uses software components) */}
			<ContributorsSection title="Team" contributors={team} />
			{/* Related projects */}
			<RelatedProjectsSection relatedProjects={relatedProjects} />
			{/* Used software */}
			<RelatedSoftwareSection relatedSoftware={relatedSoftware} />
			{/* bottom spacer */}
