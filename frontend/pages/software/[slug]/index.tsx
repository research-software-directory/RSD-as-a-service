		...
		<>
			...
			<GetStartedSection
				...
				commit_history_scraped_at={
					repositoryInfo?.commit_history_scraped_at
				}
			/>
			<CitationSection
				releases={releases}
			...
			<DarkThemeSection>
				...
				/>
				{/* Mentions */}
				<MentionsSection title="Mentions" mentions={mentions} />
			</DarkThemeSection>
			{/* Testimonials */}
			<TestimonialSection testimonials={testimonials} />
			{/* Contributors */}
			<ContributorsSection contributors={contributors} />
			<CategoriesSection categories={highlightedCategories} />
			{/* Communities */}
