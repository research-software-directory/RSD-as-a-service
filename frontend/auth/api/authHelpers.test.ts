...
it('returns authorization_endpoint', async () => {
	...
	const authorization_endpoint = await getAuthorisationEndpoint(
		'mockedWellKnowEndpoint',
	);
	expect(authorization_endpoint).toEqual(
		mockWellKnowResp.authorization_endpoint,
	);
});
