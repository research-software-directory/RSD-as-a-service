...
public class NassaSoftwareEntryTest {
	...
	void givenValidNassaYaml_whenParsing_thenSoftwareEntryReturned() {
		...
		NassaSoftwareEntry.fromYaml(new StringReader(validYaml), "https://github.com/Archaeology-ABM/NASSA-modules/tree/main/2022-Verhagen-001");
	}
}
