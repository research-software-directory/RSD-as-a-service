	...
	public static void main(String[] args) {
		...
		for (RepositoryUrlData commitData : dataToScrape) {
			try {
				...
				RepositoryUrlData updatedData = new RepositoryUrlData(commitData.id(), commitData.software(), commitData.url(),
						commitData.license(), commitData.licenseScrapedAt(), scrapedCommits, scrapedAt, commitData.languages(), commitData.languagesScrapedAt());
